...
class HomeBaseDataModel {
  String code;
  String message;
  Data data;

  HomeBaseDataModel({this.code, this.message, this.data});

  HomeBaseDataModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
...
class Floor1Pic extends FloorPic {
  String pICTUREADDRESS;
  String tOPLACE;
...
class Floor2Pic extends FloorPic {
  String pICTUREADDRESS;
  String tOPLACE;
...
class Floor3Pic extends FloorPic {
  String pICTUREADDRESS;
  String tOPLACE;
